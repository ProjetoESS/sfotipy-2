  ...
  ngOnInit(): void {
    ...
    this.playlistService.getPlaylists().subscribe(
      as => { this.playlists = as;
              ...
              //this.playlistsTrending = this.playlists.sort((a, b) => b.followers.length - a.followers.length).splice(0,4);
              this.playlistsTrending = this.playlistsPublic.sort((a, b) => b.accessPlaylits - a.accessPlaylits).slice(0, 4);
