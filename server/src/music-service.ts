...
export class MusicService {
    musics: Music[] = [
        new Music(<Music>{ 'id': 0, 'name': "Hymn for the Weekend", 'author': "Coldplay", 'image': "https://upload.wikimedia.org/wikipedia/pt/6/61/Coldplay_Hymn_for_the_Weekend.jpg", 'link': "", 'duration': 500, 'category': 3, 'access': 23 }),
        new Music(<Music>{ 'id': 1, 'name': "Viva la Vida", 'author': "Coldplay", 'image': "https://upload.wikimedia.org/wikipedia/pt/d/d7/Vivalavida.jpg", 'link': "", 'duration': 500, 'category': 2, 'access': 22 }),
        new Music(<Music>{ 'id': 2, 'name': "Yellow", 'author': "Coldplay", 'image': "https://i.pinimg.com/originals/f7/30/23/f7302371fb79c2d0cd817e9c28baaf62.jpg", 'link': "", 'duration': 500, 'category': 3 , 'access': 27 }),
        new Music(<Music>{ 'id': 3, 'name': "Paradise", 'author': "Coldplay", 'image': "https://cdns-images.dzcdn.net/images/cover/e0dd8263dfed37c50a868abbf65fd7da/500x500.jpg", 'link': "", 'duration': 500, 'category': 1, 'access': 21 }),
        ...
        new Music(<Music>{ 'id': 7, 'name': "Something Just Like This", 'author': "Coldplay", 'image': "https://i1.sndcdn.com/artworks-000252497555-rdia79-t500x500.jpg", 'link': "", 'duration': 500, 'category': 3, 'access': 19 }),
        new Music(<Music>{ 'id': 8, 'name': "Clocks", 'author': "Coldplay", 'image': "https://upload.wikimedia.org/wikipedia/pt/9/96/Clocks_single.jpg", 'link': "", 'duration': 500, 'category': 3, 'access': 20 }),
        new Music(<Music>{ 'id': 9, 'name': "Another Day in Paradise", 'author': "Phil Collins", 'image': "https://upload.wikimedia.org/wikipedia/en/thumb/5/53/Phil_Collins_AnotherDayInParadise.jpg/220px-Phil_Collins_AnotherDayInParadise.jpg", 'link': "", 'duration': 500, 'category': 3, 'access': 18}),
        ...
        new Music(<Music>{ 'id': 16, 'name': "Love The Way You Lie ft. Rihanna", 'author': "Eminem", 'image': "https://upload.wikimedia.org/wikipedia/pt/c/cb/Eminem_Rihanna_Love_The_Way_You_Lie.jpg", 'link': "", 'duration': 500, 'category': 2,'access': 17 }),
  ...
  update(music: Music): Music | null {
    const result: Music | undefined = this.musics.find(c => c.id === music.id);
    if (result) {
      result.update(music);
      return result;
    } else {
  ...
  getById(musicId: number): Music | null {
    this.accessCount++;
    const teste = this.musics.find(({id}) => id == musicId);
    if (teste==undefined){
      return null
    }
    else{
  ...
  getMostAccessed(): Music[] {
    const sortedSongs = this.musics.sort((a, b) => b.access - a.access);
